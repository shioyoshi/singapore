...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="footer wrap"><span>よりみち. / Created by GIC Kaijo G Group</span><button onClick={() => setShowPrivacy(true)}>安全とプライバシー</button><span>© 2026 GIC Kaijo G Group</span></footer>
    </main>
  );
}
